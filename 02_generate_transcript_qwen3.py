...
# Parse arguments
def parse_args():
    parser = argparse.ArgumentParser(description="Generate transcripts using Qwen3 model.")
    #parser.add_argument("--model_name", type=str, default="Qwen/Qwen3-30B-A3B", help="Name of the model.")
    parser.add_argument("--model_name", type=str, default="Qwen/Qwen3-14B", help="Name of the model.")
    ...
    parser.add_argument("--enable_thinking", action="store_true", help="Enable thinking mode for the model.")
    
    return parser.parse_args()


def format_conversation_for_qwen(user_prompt, tokenizer, enable_thinking):
...
if __name__ == "__main__":
    ...
    for i in range(0, len(dataset), batch_size):
        ...
        for user_prompt in batch:
            formatted_prompt = format_conversation_for_qwen(user_prompt, tokenizer, args.enable_thinking)
